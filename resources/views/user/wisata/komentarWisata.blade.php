      ...
      <div class="row">
            ...
            @foreach($wisata as $w)
                <style type="text/css">
                  ...
                  body{
                    background-image: url('/gambar/{{ $w->gambar}}');
                    background-size: 100%;
                  }
                </style>
                ...
                <form action="/home/wisata/komentar_wisata" method="post">
                  @csrf
                  <input type="hidden" name="id" value="{{$w->id_wisata}}" readonly><br>
                  <table class="table" style="width: 450px;">
                    
                    <tr>
                      <td colspan="2" style="text-align: center;"><h6><b>komentar wisata : {{$w->nama_wisata}}</b></h6> </td>
                    </tr>
                    <tr>
