    ...
    <div class="container">
      <div class="row">
        <div class="span12">
          ...
          <article>
            <div class="heading">
              <h3><strong>{{ $w->nama_wisata}}</strong></h3>   <!-- bagiannn nama wisata -->
            </div>
            <div class="clearfix">
            </div>
            <div class="row">
                ...
                <aside>
                  <div class="widget">
                    ...
                    <ul class="project-detail">
                                                  <!-- mulai perulangannya  -->
                      <li><label>nama wisata:</label>{{$w->nama_wisata}}</li>
                      <li><label>alamat :</label>{{$w->alamat_wisata}}</li>
                      <li><label></label></li>
...
<h4>Ulasan</h4>
          ...
          <ul class="media-list">
                            @foreach($komentarWisata as $t)
           
            <li class="media" style="">
               <b style="margin-left: 10px;">{{$t->username}}</b><br>
                  <i>"{{$t->komentar}}"  </i>
