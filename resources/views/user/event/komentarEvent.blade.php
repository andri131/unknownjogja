      ...
      <div class="row">
         @foreach($event as $e)
                <style type="text/css">
                  ...
                  body{
                    background-image: url('/gambar/{{ $e->gambar}}');
                    background-size: 100%;
                  }
                </style>
                ...
                <form action="/home/event/komentar_event" method="post">
                  @csrf
                  <input type="hidden" name="id" value="{{$e->id_event}}" readonly><br>
                  <table class="table" style="width: 450px;">
                    <tr>
                      <td colspan="2" style="text-align: center;"><h6><b>komentar wisata : {{$e->nama_event}}</b></h6> </td>
                    </tr>
                    <tr>
