    ...
    <div class="container">
      <div class="row">
        <div class="span12">
          ...
          <article>
            <div class="heading">
              <h3><strong>{{ $k->nama_kuliner}}</strong></h3>   <!-- bagiannn nama wisata -->
            </div>
            <div class="clearfix">
            </div>
            <div class="row">
                ...
                <aside>
                  <div class="widget">
                    ...
                    <ul class="project-detail">
                                                  <!-- mulai perulangannya  -->
                      <li><label>nama kuliner:</label>{{$k->nama_kuliner}}</li>
                      <li><label>alamat :</label>{{$k->alamat}}</li>
                      <li><label></label></li>
...
<h4>Ulasan</h4>
  ...
  <ul class="media-list">
                            @foreach($komentarKuliner as $kk)
           
            <li class="media" style="">
               <b style="margin-left: 10px;">{{$kk->username}}</b><br>
                <i>"{{$kk->komentar}}" </i>
