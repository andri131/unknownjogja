      ...
      <div class="row">
            ...
            @foreach($kuliner as $k)
                <style type="text/css">
                  ...
                  body{
                    background-image: url('/gambar/{{ $k->gambar}}');
                    background-size: 100%;
                  }
                </style>
                ...
                <form action="/home/kuliner/komentar_kuliner" method="post">
                  @csrf
                  <input type="hidden" name="id" value="{{$k->id_kuliner}}" readonly><br>
                  <table class="table" style="width: 450px;">
                    <tr>
                      <td colspan="2" style="text-align: center;"><h6><b>komentar wisata : {{$k->nama_kuliner}}</b></h6> </td>
                    </tr>
                    <tr>
