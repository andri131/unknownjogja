              ...
              <div class="thumbnail">
                <div class="image-wrapp">
                  ...
                  <article class="da-animate da-slideFromRight">
                    ...
                    <a href="/home/kuliner/informasiKuliner/{{ $k->id_kuliner }}"> <!-- untuk menuju ke informasi detailnya -->
                ...
                <div class="desc">
                  ...
                  <p>{{ $k->alamat}}</p>             <!-- akan diisi alamat dari wisatanya -->
                    <b style="color: blue"><a href="/home/kuliner/komentarK/{{$k->id_kuliner}}">+Komentar</a></b>
                </div>
              </div>
