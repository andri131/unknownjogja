    ...
    <div class="col-sm-4" >
      <form action="/beranda/wisata/simupdate" method="post">
        ...
        <div class="form-group" >
          ...
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="{{$w->id_wisata}}" readonly  name="id">
          <label style="color: black"><b>Nama Wisata</b></label>
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="{{$w->nama_wisata}}"  name="nama">
          <label  style="color: black"><b>Alamat Wisata</b></label>
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Alamat" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="alamat">{{$w->alamat_wisata}}</textarea>
          <label  style="color: black"><b>Deskripsi</b></label>
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Deskipsi" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="deskripsi">{{$w->deskripsi_wisata}}</textarea>
          ...
          <input type="file" class="form-control" style="width: 220px " placeholder="Nama Lengkap" name="file" value="{{$w->gambar}}"><br><br>
