...
================================================== -->
            ...
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="/gambar/{{ $w->gambar}}" alt="Portfolio name" title="" /> <!-- gambar sebagai tammpilan awalnya -->
                  <article class="da-animate da-slideFromRight">
                    <a class="zoom" data-pretty="prettyPhoto" href="/gambar/{{$w->gambar}}"> <!-- memebrikan zoom pada gambar yang dipilih -->
							         <i class="icon-bg-light icon-zoom-in icon-circled icon-2x">gambar</i>
							     </a>
                  </article>
                </div>
                <div class="desc">
                  <h5><i class="icon-file"></i> <strong>{{ $w->nama_wisata}}</strong></h5> <!-- nama tentang wisatanya -->
                  <p>{{ $w->alamat_wisata}}</p>             <!-- akan diisi alamat dari wisatanya -->
                  <a href="/beranda/wisata/hapus/{{ $w->id_wisata }}"><b style="color: black">Hapus</b></a> | <a href="/beranda/wisata/update/{{$w->id_wisata}}"><b style="color: black">Ubah</b></a>

                <!--   <script type="text/javascript">
                    function batal(){
                      var jawaban = window.confirm("yakin akan menghapus?");
                      if(jawaban === true){
                          window.location.href = "/beranda/wisata/hapus/{{ $w->id_wisata }}";
                      }else{
  ...
  <div style="margin-left: 600px;">
    <a href="/beranda/wisata/tambah"><b style="font-size: 20px">+Tambah Data</b></a>
  </div>
  <br><br><br>
