    ...
    <div class="col-sm-4" >
      <form action="/beranda/event/simupdateEvent" method="post">
        ...
        <div class="form-group" >
          ...
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="{{$e->id_event}}" readonly  name="id">
          <label style="color: black"><b>Nama event</b></label>
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="{{$e->nama_event}}"  name="nama">
          <label  style="color: black"><b>tanggal</b></label>
          <input type="date" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="{{$e->tanggal}}"  name="tanggal">
          ...
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Deskipsi" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="deskripsi">{{$e->deskripsi_event}}</textarea>
          <label style="color: black"><b>gambar</b></label>
          <input type="file" class="form-control" style="width: 220px " placeholder="Nama Lengkap" name="file" value="{{$e->gambar}}"><br><br>
