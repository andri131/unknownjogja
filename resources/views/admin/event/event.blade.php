      ...
      <div class="row">
        ...
        <div class="span8">
          <ul class="breadcrumb notop">
            ...
            <li class="active">informasi tentang event</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="/gambar/{{ $e->gambar}}" alt="Portfolio name" title="" /> <!-- gambar sebagai tammpilan awalnya -->
                  <article class="da-animate da-slideFromRight">
                    <a class="zoom" data-pretty="prettyPhoto" href="/gambar/{{$e->gambar}}"> <!-- memebrikan zoom pada gambar yang dipilih -->
							         <i class="icon-bg-light icon-zoom-in icon-circled icon-2x">gambar</i>
							     </a>
                  </article>
                </div>
                <div class="desc">
                  <h5><i class="icon-file"></i> <strong>{{ $e->nama_event}}</strong></h5> <!-- nama tentang wisatanya -->
                  <p>{{ $e->nama_wisata}}</p>             <!-- akan diisi alamat dari wisatanya -->
                  <a href="/beranda/event/hapusEvent/{{ $e->id_event }}"><b style="color: black">Hapus</b></a> | <a href="/beranda/event/updateEvent/{{$e->id_event}}"><b style="color: black">Ubah</b></a>
                </div>
                ...
                <!--  <script type="text/javascript">
                    function batal(){
                      ...
                      if(jawaban === true){
                          window.location.href = "/beranda/event/hapusEvent/{{ $e->id_event }}";
                      }else{
