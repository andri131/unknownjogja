    ...
    <div class="col-sm-4" >
      <form action="/beranda/kuliner/simupdateKuliner" method="post">
        ...
        <div class="form-group" >
          ...
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="{{$k->id_kuliner}}" readonly  name="id">
          <label style="color: black"><b>Nama Kuliner</b></label>
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="{{$k->nama_kuliner}}"  name="nama">
          <label  style="color: black"><b>Alamat Kuliner</b></label>
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Alamat" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="alamat">{{$k->alamat}}</textarea>
          <label  style="color: black"><b>Deskripsi</b></label>
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Deskipsi" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="deskripsi">{{$k->deskripsi_kuliner}}</textarea>
          <label style="color: black"><b>gambar</b></label>
          <input type="file" class="form-control" style="width: 220px " placeholder="Nama Lengkap" name="file" value="{{$k->gambar}}"><br><br>
