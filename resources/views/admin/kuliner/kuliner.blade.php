            ...
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="/gambar/{{ $k->gambar}}" alt="Portfolio name" title="" /> <!-- gambar sebagai tammpilan awalnya -->
                  <article class="da-animate da-slideFromRight">
                    <a class="zoom" data-pretty="prettyPhoto" href="/gambar/{{$k->gambar}}"> <!-- memebrikan zoom pada gambar yang dipilih -->
							         <i class="icon-bg-light icon-zoom-in icon-circled icon-2x">gambar</i>
							     </a>
                  </article>
                </div>
                <div class="desc">
                  <h5><i class="icon-file"></i> <strong>{{ $k->nama_kuliner}}</strong></h5> <!-- nama tentang wisatanya -->
                  <p>{{ $k->alamat}}</p>             <!-- akan diisi alamat dari wisatanya -->
                  <a href="/beranda/kuliner/hapusKuliner/{{ $k->id_kuliner }}"><b style="color: black">Hapus</b></a> | <a href="/beranda/kuliner/updateKuliner/{{$k->id_kuliner}}"><b style="color: black">Ubah</b></a>
                </div>
                ...
                <!--   <script type="text/javascript">
                    function batal(){
                      ...
                      if(jawaban === true){
                          window.location.href = "/beranda/kuliner/hapusKuliner/{{ $k->id_kuliner }}";
                      }else{
