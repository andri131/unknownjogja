    ...
    <div class="container">
      <div class="row">
        <div class="span12">
          ...
          <article>
            <div class="heading">
              <h3><strong><?php echo e($e->nama_event); ?></strong></h3>   <!-- bagiannn nama wisata -->
            </div>
            <div class="clearfix">
            </div>
            <div class="row">
              <div class="span8">
                ...
                <div class="flexslider">
                      <img src="/gambar/<?php echo e($e->gambar); ?>">
                </div>
                <!-- end flexslider -->
                <div class="blank10"></div>
                <p style="font-size: 15px">
                    <?php echo e($e->deskripsi_event); ?>
                ...
                <aside>
                  <div class="widget">
                    ...
                    <ul class="project-detail">
                                                  <!-- mulai perulangannya  -->
                      <li><label>nama event:</label><?php echo e($e->nama_event); ?></li>
                      <li><label>tanggal:</label><?php echo e($e->tanggal); ?></li>
                      <li><label>event ini akan diadakan di :</label><?php echo e($e->nama_wisata); ?></li>
                      <li><label></label></li>
...
<h4>Ulasan</h4>
            ...
            <ul class="media-list">
                            <?php $__currentLoopData = $komentarEvent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ke): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           
            <li class="media" style="">
               <b style="margin-left: 10px;"><?php echo e($ke->username); ?></b><br>
                <i>"<?php echo e($ke->komentar); ?>"  </i>
...
<?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views//user/event/informasiEvent.blade.php ENDPATH**/ ?>