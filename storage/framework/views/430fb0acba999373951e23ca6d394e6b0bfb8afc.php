      ...
      <div class="row">
            ...
            <?php $__currentLoopData = $wisata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <style type="text/css">
                  ...
                  body{
                    background-image: url('/gambar/<?php echo e($w->gambar); ?>');
                    background-size: 100%;
                  }
                </style>

                <form action="/home/wisata/komentar_wisata" method="post">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" name="id" value="<?php echo e($w->id_wisata); ?>" readonly><br>
                  <table class="table" style="width: 450px;">
                    
                    <tr>
                      <td colspan="2" style="text-align: center;"><h6><b>komentar wisata : <?php echo e($w->nama_wisata); ?></b></h6> </td>
                    </tr>
                    <tr>
...
<?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views//User/wisata/komentarWisata.blade.php ENDPATH**/ ?>