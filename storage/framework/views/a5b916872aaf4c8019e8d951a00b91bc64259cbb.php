    ...
    <div class="container">
      <div class="row">
        <div class="span6">
          ...
          <h3>selamat Datang <?php $__currentLoopData = $pengguna; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <p class="lead" style="text-align: justify;">
           ...
           Berawal dari sebuah keinginan berbagi maka akhirnya muncul website informatif ini, unknown jogja, dikelola dan dibangun dengan 
           penuh dedikasi. Penamaan nama website Unknown Jogja ini berasal dari Unknown yang artinya tidak diketahui dan Jogja nama kota 
           kesayangan kita. dari dua kata tersebut, menjadi Unknown Jogja yang dapat dianalogikan hal-hal yang masih jarang diketahui 
           di jogja.
          </p>
        ...
        <div class="span4">
          <div class="features">
            ...
            <div class="features_content">
              ...
              <a href="/home/wisata" class="btn btn-color btn-rounded"><i class="icon-angle-right"></i> lihat</a>
            </div>
          </div>
        </div>
        <div class="span4">
          <div class="features">
            ...
            <div class="features_content">
              ...
              <a href="home/event" class="btn btn-color btn-rounded"><i class="icon-angle-right"></i>lihat</a>
            </div>
          </div>
        </div>
        <div class="span4">
          <div class="features">
            ...
            <div class="features_content">
              ...
              <a href="home/kuliner" class="btn btn-color btn-rounded"><i class="icon-angle-right"></i>lihat</a>
            </div>
          </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views//User/home.blade.php ENDPATH**/ ?>