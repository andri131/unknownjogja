...
================================================== -->
  <section id="subintro">
    ...
    <div class="container">
      <div class="row">
        <div class="span4">
          <h3>Ubah Data <strong>Event</strong></h3>
        </div>
        <div class="span8">
          <ul class="breadcrumb notop">
            <li><a href="#">Beranda</a><span class="divider">/</span></li>
            <li class="active">ubah data event/li>
          </ul>
        </div>
      </div>
    </div>
...
<div class="container" >
  <div class="row" >
    <div class="col-sm-4" >
      <form action="/beranda/event/simupdateEvent" method="post">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group" >
          <label style="color: black"><b>id eventnya</b></label>
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="<?php echo e($e->id_event); ?>" readonly  name="id">
          <label style="color: black"><b>Nama event</b></label>
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="<?php echo e($e->nama_event); ?>"  name="nama">
          <label  style="color: black"><b>tanggal</b></label>
          <input type="date" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="<?php echo e($e->tanggal); ?>"  name="tanggal">
          <label  style="color: black"><b>nama wisata</b></label>
          
          <select class="form-control" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="namaw">
            <option><?php echo e($e->nama_wisata); ?></option>
            <?php $__currentLoopData = $wisata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php 
                  if($e->nama_wisata == $w->nama_wisata){
                    continue;
                  }else{
                    echo "<option>$w->nama_wisata</option>";
                  }
               ?>
          ...
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Deskipsi" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="deskripsi"><?php echo e($e->deskripsi_event); ?></textarea>
          <label style="color: black"><b>gambar</b></label>
          <input type="file" class="form-control" style="width: 220px " placeholder="Nama Lengkap" name="file" value="<?php echo e($e->gambar); ?>"><br><br>
...
<?php /**PATH C:\xampp\htdocs\asus\resources\views//admin/event/edit.blade.php ENDPATH**/ ?>