...
================================================== -->
  <section id="subintro">
    ...
    <div class="container">
      <div class="row">
        <div class="span4">
          <h3>Ubah Data <strong>  <kbd>Kuliner</kbd></strong></h3>
        </div>
        <div class="span8">
...
<div class="container" >
  <div class="row" >
    <div class="col-sm-4" >
      <form action="/beranda/kuliner/simupdateKuliner" method="post">
        <?php echo csrf_field(); ?>
        <?php $__currentLoopData = $kuliner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="form-group" >
          <label style="color: black"><b>id kulinernya</b></label>
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="<?php echo e($k->id_kuliner); ?>" readonly  name="id">
          <label style="color: black"><b>Nama Kuliner</b></label>
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="<?php echo e($k->nama_kuliner); ?>"  name="nama">
          <label  style="color: black"><b>Alamat Kuliner</b></label>
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Alamat" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="alamat"><?php echo e($k->alamat); ?></textarea>
          <label  style="color: black"><b>Deskripsi</b></label>
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Deskipsi" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="deskripsi"><?php echo e($k->deskripsi_kuliner); ?></textarea>
          <label style="color: black"><b>gambar</b></label>
          <input type="file" class="form-control" style="width: 220px " placeholder="Nama Lengkap" name="file" value="<?php echo e($k->gambar); ?>"><br><br>
...
<?php /**PATH C:\xampp\htdocs\asus\resources\views//Admin/kuliner/edit.blade.php ENDPATH**/ ?>