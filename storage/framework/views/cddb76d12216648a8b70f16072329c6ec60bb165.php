...
<head>
  <meta charset="utf-8">
  <title>memasukkan komentar wisata</title>
...
================================================== -->
  <section id="subintro">
    ...
    <div class="container">
      <div class="row">
        <div class="span4">
          <h3>Informasi Tentang<strong> Kulier</strong></h3>
        </div>
        <div class="span8">
      ...
      <div class="row">
            ...
            <?php $__currentLoopData = $kuliner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <style type="text/css">
                  ...
                  body{
                    background-image: url('/gambar/<?php echo e($k->gambar); ?>');
                    background-size: 100%;
                  }
                </style>

                <form action="/home/kuliner/komentar_kuliner" method="post">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" name="id" value="<?php echo e($k->id_kuliner); ?>" readonly><br>
                  <table class="table" style="width: 450px;">
                    <tr>
                      <td colspan="2" style="text-align: center;"><h6><b>komentar wisata : <?php echo e($k->nama_kuliner); ?></b></h6> </td>
                    </tr>
                    <tr>
...
<?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views//User/kuliner/komentarKuliner.blade.php ENDPATH**/ ?>