...
================================================== -->
 ...
 <section id="subintro">
    ...
    <div class="container">
      <div class="row">
        <div class="span4">
          <h3>Maaf<strong> tidak bisa mengirim</strong></h3>
        </div>
        <div class="span8">
          <ul class="breadcrumb notop">
            <li><a href="#">Home</a><span class="divider">/</span></li>
            <li class="active"><!--menampi--></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <section id="maincontent">
    <div class="container">
      <div class="row">
        <div class="span12">
          <div class="centered">
            <h2 class="error"><!-- menampilkan kode error --></h2>
            <h3>Username yang anda masukkan salah</h3>
            <p>
              Pastikan bahwa username yang anda masukkan sesuai dengan username login
            </p>
            <h4><a href="/home/event">silahkan kembali</a></h4>
          </div>
        </div>
      </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\asus\resources\views//User/event/gagalKomentar.blade.php ENDPATH**/ ?>