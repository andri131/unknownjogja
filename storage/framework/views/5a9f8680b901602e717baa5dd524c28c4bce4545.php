...
================================================== -->
  <section id="subintro">
    ...
    <div class="container">
      <div class="row">
        <div class="span4">
          <h3>Tambah Data <strong>Wisata</strong></h3>
        </div>
        <div class="span8">
...
<div class="container" >
  <div class="row" >
    <div class="col-sm-4" >
      <form action="/beranda/wisata/simpanData" method="post">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views/admin/wisata/tambah.blade.php ENDPATH**/ ?>