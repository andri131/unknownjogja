                          ...
                          function logout(){
                              ...
                              if(jawaban === true){
                                  window.location.href = "/keluar";
                                   ...
                                   window.location.href = "/beranda/wisata";
                              }
                          }  
                        </script>
...
================================================== -->
  <section id="subintro">
    ...
    <div class="container">
      <div class="row">
        <div class="span4">
          <h3>Ubah Data <strong>Wisata</strong></h3>
        </div>
        <div class="span8">
...
<div class="container" >
  <div class="row" >
    <div class="col-sm-4" >
      <form action="/beranda/wisata/simupdate" method="post">
        <?php echo csrf_field(); ?>
        ...
        <div class="form-group" >
          <label style="color: black"><b>id wisatanya</b></label>
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="<?php echo e($w->id_wisata); ?>" readonly  name="id">
          <label style="color: black"><b>Nama Wisata</b></label>
          <input type="text" class="form-control" placeholder="Nama Lengkap" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" value="<?php echo e($w->nama_wisata); ?>"  name="nama">
          <label  style="color: black"><b>Alamat Wisata</b></label>
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Alamat" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="alamat"><?php echo e($w->alamat_wisata); ?></textarea>
          <label  style="color: black"><b>Deskripsi</b></label>
          <textarea type="text" class="form-control" cols="40" rows="5" placeholder="Deskipsi" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="deskripsi"><?php echo e($w->deskripsi_wisata); ?></textarea>
           <label style="color: black"><b>kategori</b></label>
            <select class="form-control" style="box-shadow: inset 2px 2px 2px 2px rgba(0,0,0,0.2);" name="kategori">
            <option><?php echo e($w->kategori); ?></option>
            <?php $__currentLoopData = $kategori; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php 
                  if($w->kategori == $k->kategori ){
                    continue;
                  }else{
                    echo "<option>$k->kategori</option>";
                  }
               ?>
          ...
          <input type="file" class="form-control" style="width: 220px " placeholder="Nama Lengkap" name="file" value="<?php echo e($w->gambar); ?>"><br><br>
...
<?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views//Admin/wisata/edit.blade.php ENDPATH**/ ?>