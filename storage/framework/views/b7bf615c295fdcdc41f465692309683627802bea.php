...
================================================== -->
  <section id="subintro">
    ...
    <div class="container">
      <div class="row">
        <div class="span4">
          <h3>Menampilkan Detai <strong>kuliner</strong></h3>
        </div>
        <div class="span8">
          <ul class="breadcrumb notop">
            <li><a href="/home">Beranda</a><span class="divider">/</span></li>
            <li class="active">menampilkan detail kuliner</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="span12">
          ...
          <article>
            <div class="heading">
              <h3><strong><?php echo e($k->nama_kuliner); ?></strong></h3>   <!-- bagiannn nama wisata -->
            </div>
            <div class="clearfix">
            </div>
            <div class="row">
              <div class="span8">
                ...
                <div class="flexslider">
                      <img src="/gambar/<?php echo e($k->gambar); ?>">
                </div>
                <!-- end flexslider -->
                <div class="blank10"></div>
                <p style="font-size: 15px">
                    <?php echo e($k->deskripsi_kuliner); ?>
                ...
                <aside>
                  <div class="widget">
                    ...
                    <ul class="project-detail">
                                                  <!-- mulai perulangannya  -->
                      <li><label>nama kuliner:</label><?php echo e($k->nama_kuliner); ?></li>
                      <li><label>alamat :</label><?php echo e($k->alamat); ?></li>
                      <li><label></label></li>
...
<h4>Ulasan</h4>
  ...
  <ul class="media-list">
                            <?php $__currentLoopData = $komentarKuliner; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           
            <li class="media" style="">
               <b style="margin-left: 10px;"><?php echo e($kk->username); ?></b><br>
                <i>"<?php echo e($kk->komentar); ?>" </i>
...
<?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views//user/kuliner/informasiKuliner.blade.php ENDPATH**/ ?>