            ...
            <div class="span4">
              <div class="thumbnail">
                ...
                <div class="desc">
                  ...
                  <a href="/beranda/wisata/hapus/<?php echo e($w->id_wisata); ?>"><b style="color: black">Hapus</b></a> | <a href="/beranda/wisata/update/<?php echo e($w->id_wisata); ?>"><b style="color: black">Ubah</b></a>

                <!--   <script type="text/javascript">
                    function batal(){
                      var jawaban = window.confirm("yakin akan menghapus?");
                      if(jawaban === true){
                          window.location.href = "/beranda/wisata/hapus/<?php echo e($w->id_wisata); ?>";
                      }else{
                          window.location.href = "/beranda/wisata";
                      }
...
<?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views/admin/wisata/wisata.blade.php ENDPATH**/ ?>