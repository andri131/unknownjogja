...
<head>
  <meta charset="utf-8">
  <title>menampilkan Kuliner</title>
                          ...
                          function logout(){
                              ...
                              if(jawaban === true){
                                  window.location.href = "/keluar";
                                   ...
                                   window.location.href = "/beranda/kuliner";
                              }
                          }  
                        </script>
...
================================================== -->
  <section id="subintro">
    ...
    <div class="container">
      <div class="row">
        <div class="span4">
          <h3>Informasi Tentang<strong> Kuliner</strong></h3>
        </div>
        <div class="span8">
          <ul class="breadcrumb notop">
            <li><a href="#">beranda</a><span class="divider">/</span></li>
            <li class="active">informasi tentang kuliner</li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="span4">
              <div class="thumbnail">
                <div class="image-wrapp">
                  <img src="/gambar/<?php echo e($k->gambar); ?>" alt="Portfolio name" title="" /> <!-- gambar sebagai tammpilan awalnya -->
                  <article class="da-animate da-slideFromRight">
                    <a class="zoom" data-pretty="prettyPhoto" href="/gambar/<?php echo e($k->gambar); ?>"> <!-- memebrikan zoom pada gambar yang dipilih -->
							         <i class="icon-bg-light icon-zoom-in icon-circled icon-2x">gambar</i>
							     </a>
                  </article>
                </div>
                <div class="desc">
                  <h5><i class="icon-file"></i> <strong><?php echo e($k->nama_kuliner); ?></strong></h5> <!-- nama tentang wisatanya -->
                  <p><?php echo e($k->alamat); ?></p>             <!-- akan diisi alamat dari wisatanya -->
                  <a href="/beranda/kuliner/hapusKuliner/<?php echo e($k->id_kuliner); ?>"><b style="color: black">Hapus</b></a> | <a href="/beranda/kuliner/updateKuliner/<?php echo e($k->id_kuliner); ?>"><b style="color: black">Ubah</b></a>
                </div>
                ...
                <!--   <script type="text/javascript">
                    function batal(){
                      ...
                      if(jawaban === true){
                          window.location.href = "/beranda/kuliner/hapusKuliner/<?php echo e($k->id_kuliner); ?>";
                      }else{
                          window.location.href = "/beranda/kuliner";
                      }
  ...
  <div style="margin-left: 600px;">
    <a href="/beranda/kuliner/tambahKuliner"><b style="font-size: 20px">+Tambah Data</b></a>
  </div>
  <br><br><br>
...
<?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views/admin/kuliner/kuliner.blade.php ENDPATH**/ ?>