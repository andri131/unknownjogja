    ...
    <div class="container">
      <div class="row">
        <div class="span6">
          ...
          <p class="lead">
            penjelasan tentang website kita penjelasan tentang website kita penjelasan tentang website kita penjelasan tentang website kita penjelasan tentang website kitapenjelasan tentang website kita
          </p>
          <ul class="list list-ok strong bigger">
            <li>ciri-ciri website</li>
            <li>ciri-ciri website</li>
            <li>ciri-ciri website</li>
          </ul>
          ...
          <div class="group section-wrap upper" id="upper">
            <div class="section-2 group">
              <ul id="images" class="rs-slider">
                <li class="group">
                  <a href="#">
				            <img width="1000px" src="utama/assets/img/slides/refine/slide1.jpg" alt="" />
				        </a>
                </li>
                <li class="group">
                  <a href="#" class="slide-parent">
				            <img width="1000px" src="utama/assets/img/slides/refine/slide2.jpg" alt=""/>
				        </a>
                </li>
                <li class="group">
                  <img width="1000px" src="utama/assets/img/slides/refine/slide3.jpg" alt="" />
                </li>
              </ul>
            </div>
            <!-- /.section-2 -->
        ...
        <div class="span4">
          <div class="features">
            ...
            <div class="features_content">
              ...
              <a href="#" class="btn btn-color btn-rounded"><i class="icon-angle-right"></i> lihat</a>
            </div>
          </div>
        </div>
        <div class="span4">
            ...
            <div class="accordion-group">
              ...
              <div id="collapseOne" class="accordion-body collapse in">
                <div class="accordion-inner">
                  penjelasan tentang layanan kita
                </div>
              </div>
            </div>
            <div class="accordion-group">
...
<?php /**PATH C:\xampp\htdocs\asus\resources\views/beranda.blade.php ENDPATH**/ ?>