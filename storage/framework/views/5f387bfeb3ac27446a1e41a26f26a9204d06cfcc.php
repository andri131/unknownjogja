...
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="login dan regis/images/icons/favicon.ico"/>
<!--===============================================================================================-->
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="kirimdata" method="post">
					...
					<div class="container-login100-form-btn">
						<input type="submit" class="login100-form-btn" name="">
					</div>
				</form>
			</div>
		</div>
...
</html><?php /**PATH C:\xampp\htdocs\Unknown Jogja\resources\views/login.blade.php ENDPATH**/ ?>